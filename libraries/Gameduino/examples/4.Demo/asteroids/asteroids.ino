...
const PROGMEM prog_uchar charsin[16] = {0, 48, 89, 117, 127, 117, 89, 48, 0, -48, -89, -117, -127, -117, -89, -48};
...
{
  if (src != 0xff) {
    prog_uchar *psrc = (prog_uchar *)title_runs + 2 * src;
    byte a, b;
    do {
...
{
  GD.copy(PALETTE16A, (const prog_uchar *)palette16a, sizeof(palette16a));
  GD.copy(PALETTE4A, (const prog_uchar *)palette4a, sizeof(palette4a));
  GD.copy(PALETTE16B, (const prog_uchar *)palette16b, sizeof(palette16b));
